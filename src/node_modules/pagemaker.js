...
Jaml.register('stdpage', function(page)
    {
        html(
            ...
            body(
				...
				script({src:"/js/gen_feed.js", type:"text/javascript"})
            )
        );
    });
...
StandardPage = function()
{
    ...
    this.script = [{url:"/js/jquery-1.5.min.js"}];
     ...
     *    to the url 'newurl'
     */
    this.addStdMenuItem = function(newdisplay, newurl) 
        { 
            this.menu[this.menu.length] = {display:newdisplay, url:newurl }; 
        }
    /*
     * addMenuItem(String newdisplay, String newurl)
     *    adds a new menu link, with the display name 'newdisplay'
     *    to the url 'newurl'  
     *     THIS WILL GO IN MENU2 (IE. PAGE SPECIFIC MENU'S)
     */
    this.addMenuItem = function(newdisplay, newurl) 
        { 
            this.extraMenu[this.extraMenu.length] = {display:newdisplay, url:newurl }; 
        }
    /*
    ...
    this.toHTML = function() 
        { 
			this.addContent("<script>pullGenFeedsTo('FeedsBox');</script>");
    ...
    {
        this.addStdMenuItem("Main", "index.html");
        this.addStdMenuItem("Signup", "signup.html");
        this.addStdMenuItem("Task Page", "taskpage.html");
        this.addStdMenuItem("Update Task", "updatetask.html");
        this.addStdMenuItem("Add Task", "addtask.html");
        this.addStdMenuItem("User Profile", "UserProfile");
    }
}
...
exports.ParsePage = function(file, callback) {
    ...
    //find the body of the page
		...
		page1.addScript("/js/gen_feed.js");
		page1.addContent("<script>pullGenFeedsTo('FeedsBox');</script>");
