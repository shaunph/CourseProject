 ...
 */
exports.updateTask = function(id, name, desc, level, prog, stats, callback) {
    queryGetRows("UPDATE task SET taskName = ?, description = ?, priority = ?, progress = ?, status = ? WHERE taskid = ?", 
