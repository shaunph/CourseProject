...
/**
    ...
    Parameter5: the task status. (String)
    Parameter6: callback. (function)
    
    This function updates the information about a task object.
 */
exports.updateTask = function(id, name, desc, level, stats, callback) {
    queryGetRows("UPDATE task SET taskName = ?, description = ?, priority = ?, status = ? WHERE taskid = ?", 
	callback, [name, desc, level, stats, id]);
}
