 ...
 *	    + "<th>" + header[n] + "</th>"
 */
module.exports.Jaml.register('tableheader', function (header) {
    th(header.toString());
});
 ...
 * as above.
 */
module.exports.Jaml.register('tablerow', function (row) {
 ...
 * as above.
 */
module.exports.Jaml.register('tablecell', function (cell) {
    td(cell);
});
 ...
 */
module.exports.Jaml.register('table', function (input) {
