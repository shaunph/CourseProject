...
>>>>>>> 0143d8981d4fcebdda2cf9dc9e372bfbff98ba7f
	...
	if (user == "J DOE") {
	    ...
	    tPage.setTitle('NOT LOGGED ON');
      	    tPage.setContent("<h1> YOU MUST BE LOGGED ON TO DO THIS! </h1> <br />");
	    tPage.addContent("<a href='login.html'><b>Go and Login</b></a> </div>");		    
	    tPage.addContent("<a href='index.html'><b>Or Back to Main</b></a> </div>");
	    response.write(tPage.toHTML());
            response.end(); 
	}
	else {
